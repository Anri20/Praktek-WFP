    ...
    <div class="row stats-overview-cont">
        <div class="col-md-2 col-sm-4">
            <div class="stats-overview stat-block">
                ...
                <div class="progress">
                    <span style="width: 40%;" class="progress-bar progress-bar-info" aria-valuenow="66" aria-valuemin="0"
                        aria-valuemax="100">
                        <span class="sr-only">
                            66% Complete </span>
                    </span>
            ...
            <div class="portlet">
                ...
                <div class="portlet-body">
                    <div id="site_statistics_loading">
                        <img src="{{ asset('assets/conquer2/img/loading.gif') }}" alt="loading" />
                    </div>
                            ...
                            <div class="scroller" style="height: 250px;" data-always-visible="1" data-rail-visible1="1">
                                <div class="row">
                                    <div class="col-md-6 user-info">
                                        <img alt="" src="{{ asset('assets/conquer2/img/avatar.png') }}"
                        ...
                        <ul class="chats">
                            <li class="in">
                                <img class="avatar img-responsive" alt=""
                                    src="{{ asset('assets/conquer2/img/avatar1.jpg') }}" />
                                <div class="message">
                                    <span class="arrow">
                                    </span>
                            ...
                            <li class="out">
                                <img class="avatar img-responsive" alt=""
                                    src="{{ asset('assets/conquer2/img/avatar2.jpg') }}" />
                                <div class="message">
                                    <span class="arrow">
                                    </span>
                            ...
                            <li class="out">
                                <img class="avatar img-responsive" alt=""
                                    src="{{ asset('assets/conquer2/img/avatar3.jpg') }}" />
                                <div class="message">
                                    <span class="arrow">
                                    </span>
